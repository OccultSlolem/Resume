...
\begin{document}
    ...
    \personalinfo{
        \email{me@ethan-hanlon.xyz}\smallskip
        \phone{+01-408-607-7715}
        \location{San Francisco, CA}\\
        \linkedin{in/ethan-hanlon-6688491a6/}
        \github{OccultSlolem}
        \homepage{https://ethan-hanlon.xyz}
        %\medium{nicolasomar}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Strengths}
            ...
            \cvtag{Python}
            \cvtag{Cloud}
            \cvtag{Leadership Experience}
            \cvtag{Life Scout. BSA}
        % ----- STRENGTHS -----
        ...
        \cvsection{Experience}
            \cvevent{ Software/EE Internship }{| Towa Industries, Inc.}{July 2022 - Ongoing}{Campbell, CA}
            \begin{itemize}
        ...
        % \cvevent{Innovation Entrepeneurship Fellowship Candidate }{| SFSU}{Sept 2020 -- Ongoing}{San Francisco, CA}
          %  \begin{itemize}
           %     \item Received capital and mentorship to start business
            ...
            \end{itemize}
            \divider
            \cvevent{ Front Desk Receptionist }{| Morgan Hill Bowl}{May 2021 - August 2022}{Morgan Hill, CA}
            \begin{itemize}
                \item Sold lanes, handled cash, assisted with cleaning, and provided customer service.
            \end{itemize}
            % \cvevent{ Fellow }{| California College Corps}{October 2022 - Ongoing}{San Francisco, CA}
            % \begin{itemize}
            %     \item Committed four hundred hours of community service through current academic year
            %     \item Assigned to Alemany Farm, assisting the community through growing free food
            % \end{itemize}
        ...
        \cvsection{Projects}
            \cvevent{Towa Shop}
            {\cvrepo{| \faGlobe}{https://shop.towatools.com}}{July 2023 -- Present}{}
            \begin{itemize}
            ...
            \end{itemize}
            % \cvevent{PediaTrac}{\cvrepo{| \faGithub}{https://github.com/OccultSlolem/PediaTrac-iOS}}{}{}            \begin{itemize}
